    ...
    <div class="l-header__inner">
      ...
      <?php if (!empty($page['header_contact_details'])): ?>
        <div class="l-header__contact-details">
          <?php if(isset($variables['title']) && $variables['title'] == 'Used Cars' || $variables['title'] == 'New Cars' || isset($node->type) && $node->type == 'used_vehicle'): ?>
            <?php print views_embed_view('csmc_branch_info', 'header_sales_number'); ?>
          <?php else: ?>
