...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> l-node-frontpage--full clearfix">
  ...
  <?php endif; ?>
   ...
   <div class="l-node-frontpage--full__pixxnow">
    <div class="l-node-frontpage--full__pixxnow-inner">
      <div class="pixxnow-block">
        <h2>Customer Testimonials</h2>
        <object width="100%" height="350" data="http://pixxnow.com/feed?dealer=another-happy-customer-2&type=horizontal"></object>
      </div>
    </div>
  </div>
