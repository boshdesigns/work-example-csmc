...
function peugeot_csmc_entity_view_alter(&$build, $type){
...
function peugeot_csmc_fmg_solr_count() {
  $count = fmg_solr_current_search_count();
  return '<div class="used-search-block-count">' . $count . ' <span>Results</span></div>';
}

function peugeot_csmc_field__minimal__field_address__branch($variables) {
